...
parser.add_argument('--resblocks', default=5, type=int, help='resblocks')
...
parser.add_argument('--nl', default='elu', type=str, help='non linearity')

parser.add_argument('--stopping_patience', default=30, type=int, help='stopping patience')
parser.add_argument('--learning_patience', default=10, type=int, help='stopping patience')
...
parser.add_argument('--rotation_range', default=5, type=float, help='dropout1')
parser.add_argument('--width_shift_range', default=0.15, type=float, help='dropout2')
parser.add_argument('--height_shift_range', default=0.15, type=float, help='dropout2')
...
def train_teacher(n_classes = config['n_classes'], network_topology=config['network_topology']):
    print('config  ',config)
